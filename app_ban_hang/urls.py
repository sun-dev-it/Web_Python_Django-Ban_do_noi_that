...
urlpatterns = [
    ...
    path('order/<int:DonHang_id>/', views.DonHangDaMua, name='donhangdamua'),
    path('order/<int:item_id>/delete/', views.XoaDonHang, name='XoaDonHang'),
    ...
    path('blog/<int:pk>/', views.Like, name='like_blog'),
    ##################################################################################################################
